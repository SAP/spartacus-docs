...
- [Building the TUA Spartacus Storefront using 4.1 Libraries]({{ site.baseurl }}{% link _pages/telco/building-the-tua-storefront-from-libraries-4.1.md %})
- [Building the TUA Spartacus Storefront using 4.0 Libraries]({{ site.baseurl }}{% link _pages/telco/building-the-tua-storefront-from-libraries-4.md %})
- [Building the TUA Spartacus Storefront using 3.2 Libraries]({{ site.baseurl }}{% link _pages/telco/building-the-tua-storefront-from-libraries-3-2-0.md %})
- [Building the TUA Spartacus Storefront using 3.1 Libraries]({{ site.baseurl }}{% link _pages/telco/building-the-tua-storefront-from-libraries-3.1.md %})
