---
title: Installing SAP Commerce Cloud for use with TUA Spartacus 3.1
---
...
1. Unzip the sample data.
    ...
    **Note:** You can use all three store extensions, or only one of them, depending on your needs (specific to Telco or to Utilities).
