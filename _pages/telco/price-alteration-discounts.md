...
- [Introducing Price Alteration Discounts Feature](#introducing-price-alteration-discounts-feature)
- [Changes Implemented](#changes-implemented)
- [Creating and Configuring Price Alterations - Discounts in TUA](#creating-and-configuring-price-alterations--discounts-tua)
...
The following figure illustrates hirarchical structure of the price alteration discounts, with price alteration for Signature Unlimited Plan that is configured by the Administrator in the backoffice as an example.
...
To create price alterations - discounts and to configure the prices using product offering prices, see [Creating Price Row for a Price Context](https://help.sap.com/viewer/32f0086927f44c9ab1199f1dab8833cd/2011/en-US/edd790667fd54960a216646c85deb5a7.html) in the TUA Help portal.
