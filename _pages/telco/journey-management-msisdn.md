...
The Journey Management - MSISDN feature enables the customers browsing the TUA for SPA Storefront to browse the contents of Single Product Offerings (SPOs) and provide the MSISDN(Virtual Mobile Number) before adding the chosen offerings to the cary, based on the checklist actions configured by the Product Manager.
