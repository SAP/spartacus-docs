...
**Note:** Spartacus 1.x requires Angular 8. For more information, see   [Installing SAP Commerce Cloud for TUA Spartacus]({{ site.baseurl }}{% link_pages/telco/installation-guide-for-tua-spartacus.md %}).
...
- [Simple Product Offering]({{ site.baseurl }}{% link _pages/telco/simp le-product-offering.md %}).
...
- Please visit our Spartacus for TUA Compatibility Matrix to understand requirements. For more information, see [Feature Release Versions]({{ site.baseurl }}{% link _pages/telco/feature-release-versions.md %}).
