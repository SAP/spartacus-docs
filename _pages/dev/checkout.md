...
- TBD:bgj description for checkout. Truthy document of overall checkout + the extending-checkout.md (will remove that file for all in one)
...
- TBD:bgj (schematics steps on getting checkout 'features' in)
...
- TBD:bgj (pretty redundant I think)
