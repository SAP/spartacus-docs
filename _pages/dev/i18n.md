...
**Note: When using SSR mode, build artifacts are loaded directly from the local file system by Webpack, which is more efficient than loading them via an HTTP request.**
