...
In case of translation missing for a particular key, storefront in production mode displays non-breaking space character. To make it easier to catch those missing keys in development mode you will see translation key (eg. `[common:form.confirm]`).
