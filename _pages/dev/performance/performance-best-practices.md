...
- Use HTTP compression, for example, with Brotli or Zstd, whenever possible to improve transfer speed and to optimize bandwidth.
...
- If possible, rely on the CDN to optimize images: Some CDN providers can automatically optimize images by converting them to modern formats like WebP or AVIF, resizing them, and applying compression. This can significantly reduce the size of image files and improve loading times.
