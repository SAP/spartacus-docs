...
- Cache Static Assets and Dynamic Prerendered Routes: Configure your CDN to cache static assets, including images, CSS, JavaScript files, fonts, and prerendered routes. This reduces the load on your origin server and accelerates content delivery to users, generally improving Core Web Vital metrics such as LCP.
