...
Note to Matt: Perhaps all of the above info should be transferred to keyboard-accessibility.md or regrouped as follow to reflect the A11Y Roadmap https://wiki.wdf.sap.corp/wiki/display/spar/Accessibility+Roadmap

- Basic accessibility
- Keyboard accessibility
- Screen Reader accessibility (link to screen-reader-accessibility.md)
- Media accessibility
- Conformance by no-content
