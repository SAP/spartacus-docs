...
- Include initial documentation input, which is provided by the developer. For more information, see [Developers: Contributing to Documentation](https://github.com/SAP/spartacus-docs/blob/main/contributing_to_docs/developer-guide.md).
