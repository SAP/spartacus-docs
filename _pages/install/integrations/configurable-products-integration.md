...
When you refresh the browser, the product configuration is persisted, in case you are logged in. If you are not logged in, the product configuration is reset to the default configuration and you therefore have to reconfigure your products after reloading the page.
