...
Enum representing different payment methods (e.g., `APPLE_PAY`, `GOOGLE_PAY`, etc.)

### OpfErrorDialogOptions

Interface for configuring error dialog display options with default values available.

### OpfPaymentConfig

```typescript
interface OpfPaymentConfig {
...
Contains payment session information returned from `initiatePayment`.

### OpfPaymentVerificationPayload

Payload object for payment verification requests.

### OpfPaymentVerificationResponse

Response object from payment verification.
...
Contains delivery mode information including code, name, and delivery cost.

### Cart

Contains cart information including items, totals, addresses, and delivery mode.
