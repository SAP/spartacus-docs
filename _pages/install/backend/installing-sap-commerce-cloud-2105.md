...
- Step 4: Update system and user credentials (2105 only) (optional)
  
### Step 1: Download, unzip, and create the new recipe

1. Download and unzip the following files:
   - SAP Commerce Cloud (release 2105 recommended) from the [SAP Software Downloads web site](https://launchpad.support.sap.com/#/softwarecenter/template/products/_APP=00200682500000001943&_EVENT=NEXT&HEADER=Y&FUNCTIONBAR=Y&EVENT=TREE&NE=NAVIGATE&ENR=67837800100800007216&V=MAINT&TA=ACTUAL/SAP%20COMMERCE). 
...
If you are using SAP Commerce Cloud 2105, you may need to enable users and passwords for certain functionality to work.
