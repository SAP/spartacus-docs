...
Release notes: https://github.com/SAP/spartacus/releases
...
- To use the new libraries, set your @spartacus libraries in package.json to “~1.#.0" (replace # with the release number). Then, delete your node_modules and do `yarn install`.
