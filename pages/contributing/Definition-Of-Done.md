...
For more information, see [Development Tools for Spartacus]({{ site.baseurl }}{% link pages/contributing/Development-Tools-for-Spartacus.md %}).

## Code is Styled

For more information, see [Coding Guidelines]({{ site.baseurl }}{% link pages/contributing/Coding-Guidelines.md %}).
