...
This cheat sheet explains in depth most of the formatting and syntax you are likely to need, but the following also include some details not covered by the first one:
