...
- **Curly Braces:** When a Jekyll build is run, double curly braces (that is, &#123;&#123; and &#125;&#125;) are interpreted as Liquid filters, with the result that the contents between the curly braces are either removed, or sometimes even processed!
